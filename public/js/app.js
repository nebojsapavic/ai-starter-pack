...
function renderHome(app) {
  ...
  <div class="page">
    <section class="hero">
      <img class="hero-img" src="/img/head.png" alt="AI">
      <div class="hero-left">
        <div class="hero-badge">Dostupna svima!</div>
        <h1 class="hero-h1">Veštačka<br>inteligencija<em>.</em></h1>
        <p class="hero-sub">objašnjena jednostavno.</p>
      </div>
      <div class="hero-right">
        <div class="hero-card">
          <div class="hero-card-logo">${logoSVG(38)}</div>
          <p>Besplatan online kurs kroz 7 praktičnih modula – nauči kako veštačka inteligencija funkcioniše, gde je koristiš svakodnevno i kako ti može pomoći da učiš, radiš i misliš pametnije.</p>
          <div class="hero-btns">
            <button class="btn btn-dark" onclick="navigate('login')">Login</button>
            <button class="btn btn-red" onclick="navigate('register')">Sign Up</button>
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="sec reveal">
      <div class="sec-label">Sadržaj kursa</div>
      <h2 class="sec-h">Šta te čeka u kursu?</h2>
      <div class="course-grid">
        ${[
          ['01','Osnove AI i kako "razmišlja"','Pojmovi, razlike, istorija i primeri iz svakodnevnog života'],
          ['02','Kako AI rešava probleme','Logika, algoritmi pretrage, igre i simulacije'],
          ['03','Uvod u mašinsko učenje','Nadgledano/nenadgledano, klasifikacija, regresija'],
          ['04','Neuronske mreže – digitalni mozak','Slojevi, backpropagation, CNN, transformeri'],
          ['05','AI u učenju, poslu i svakodnevici','Produktivnost, asistenti, organizacija vremena'],
          ['06','Odgovorno korišćenje AI','Pristrasnost, privatnost, etika i odgovornost'],
        ].map(([n,t,d]) => `
          <div class="c-item">
            <div class="c-num">${n}</div>
            <div><div class="c-title">${t}</div><div class="c-desc">${d}</div></div>
          </div>`).join('')}
      </div>
    </section>
    ...
    <section class="world-sec reveal">
      <div class="world-text">
        <div class="world-pre">Kako</div>
        <div class="world-h">AI MENJA SVET</div>
        <div class="world-h2">U KOJEM ŽIVIMO</div>
        <button class="btn btn-red" onclick="navigate('modules')">ZAPOČNI – Otkrij moć AI-a</button>
      </div>
      <img class="world-globe" src="/img/world.png" alt="AI World">
    </section>
    ...
    <section class="mobile-sec reveal">
      <div>
        ...
        <p class="mobile-p">Kurs je online, interaktivan i dostupan na svim uređajima.</p>
        <p class="mobile-p">Na kraju kursa dobijaš <span class="hi">digitalni sertifikat</span> i <span class="hi">2 ECTS boda!</span></p>
        <p class="mobile-p" style="margin-top:6px">Sertifikat nosi i <span class="hi">100€ popust</span> za upis na ITS ili ITHS.</p>
        <div style="display:flex;gap:12px;margin-top:32px">
          <button class="btn btn-outline" onclick="navigate('login')">Login</button>
          <button class="btn btn-red" onclick="navigate('register')">Registruj se</button>
        </div>
      </div>
    ...
    <section class="slogan-sec reveal">
      ...
      <div class="slogan-sub">Upoznaj moć veštačke inteligencije i pozicioniraj se.</div>
      <button class="btn btn-red" onclick="navigate('register')">Registruj se – potpuno besplatno</button>
    </section>
    <div class="div-h"></div>
  </div>`;
}
